...
The method proposed in this project (and its relate works) can be applied to all manually annotated deep learning tasks, not just NLP tasks, but can be efficiently extended to CV tasks, speech recognition tasks, TTS tasks, and more.
